...
func sampleReviewProfilesFile() *config.ProfilesFile {
	return &config.ProfilesFile{
		ContainerReviewGoalConfig:     `{"$schema":"https://prism.ai/harness-config.json","default_agent":"review-goal","agent":{"review-goal":{}}}`,
		ContainerReviewCodeConfig:     `{"$schema":"https://prism.ai/harness-config.json","default_agent":"review-code","agent":{"review-code":{}}}`,
		ContainerReviewSecurityConfig: `{"$schema":"https://prism.ai/harness-config.json","default_agent":"review-security","agent":{"review-security":{}}}`,
		ContainerReviewQaConfig:       `{"$schema":"https://prism.ai/harness-config.json","default_agent":"review-qa","agent":{"review-qa":{}}}`,
		ContainerReviewContextConfig:  `{"$schema":"https://prism.ai/harness-config.json","default_agent":"review-context","agent":{"review-context":{}}}`,
	}
}
...
// the per-agent harness-config.json blob is sourced from profiles.json via
...
func TestResolveAgentConfigContent_OverlaysRuntimeActiveProfile(t *testing.T) {
	pf := &config.ProfilesFile{
		...
		ContainerReviewGoalConfig: `{"$schema":"https://prism.ai/harness-config.json","default_agent":"review-goal","model":"anthropic/claude-sonnet-4-6","agent":{"review-goal":{"model":"anthropic/claude-sonnet-4-6","variant":"none"}}}`,
	}
